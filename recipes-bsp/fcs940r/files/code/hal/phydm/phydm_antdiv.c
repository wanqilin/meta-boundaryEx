...
void phydm_rx_hw_ant_div_init_8735b(void *dm_void)
{
	...
	PHYDM_DBG(dm, DBG_ANT_DIV, "[%s]=====>\n", __func__);
	/* @[BB] */
	odm_set_bb_reg(dm, R_0x1c94, BIT(4) | BIT(5), 0x3); /* output enable */
	odm_set_bb_reg(dm, R_0x1ca0, BIT(4) | BIT(5), 0x0);
	odm_set_bb_reg(dm, R_0x1c98, BIT(8) | BIT(9), 0x0);
		/* r_rfe_path_sel_   (RFE_CTRL_4) */
	odm_set_bb_reg(dm, R_0x1c98, BIT(10) | BIT(11), 0x0);
		/* r_rfe_path_sel_   (RFE_CTRL_5) */
	odm_set_bb_reg(dm, R_0x1838, BIT(28), 0); /* RFE_buffer_en */
	odm_set_bb_reg(dm, R_0x183c, BIT(4), 1); /* rfe_inv  (RFE_CTRL_4) */
	odm_set_bb_reg(dm, R_0x183c, BIT(5), 0); /* rfe_inv  (RFE_CTRL_5) */
	odm_set_bb_reg(dm, R_0x1840, 0xF0000, 0x8); /* path-A, RFE_CTRL_4 */
	odm_set_bb_reg(dm, R_0x1840, 0xF00000, 0x8); /* path-A, RFE_CTRL_5 */
	/* @3 ------------------------- */
